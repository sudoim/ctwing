...
namespace Sudoim\CTWing\Kernel\Log;
...
{
    /**
     * @var \Sudoim\CTWing\Kernel\ServiceContainer
     */
    protected $app;
     ...
     *
     * @param \Sudoim\CTWing\Kernel\ServiceContainer $app
     */
    ...
    {
        return new Monolog('CTWing', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/ctwing/ctwing.log',
